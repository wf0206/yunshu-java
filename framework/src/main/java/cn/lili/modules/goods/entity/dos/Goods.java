...
public class Goods extends BaseEntity {
    ...
    @ApiModelProperty(value = "商品名称")
    @NotEmpty(message = "MY商品名称不能为空")
    @Length(max = 100, message = "商品名称太长，不能超过100个字符")
    private String goodsMyName;

    @ApiModelProperty(value = "商品名称")
    @NotEmpty(message = "UK商品名称不能为空")
    @Length(max = 100, message = "商品名称太长，不能超过100个字符")
    private String goodsUkName;
    ...
    @Length(max = 60, message = "商品卖点太长，不能超过60个字符")
    @ApiModelProperty(value = "卖点")
    private String sellingUkPoint;
    @Length(max = 60, message = "商品卖点太长，不能超过60个字符")
    @ApiModelProperty(value = "卖点")
    private String sellingMyPoint;
    ...
    @ApiModelProperty(value = "商品移动端详情")
    private String mobileMyIntro;

    @ApiModelProperty(value = "商品移动端详情")
    private String mobileUkIntro;
    ...
    public Goods(GoodsOperationDTO goodsOperationDTO) {
        ...
        this.goodsUkName = goodsOperationDTO.getGoodsUkName();
        this.goodsMyName = goodsOperationDTO.getGoodsMyName();
        ...
        this.sellingMyPoint = goodsOperationDTO.getSellingMyPoint();
        this.sellingUkPoint = goodsOperationDTO.getSellingUkPoint();
        this.salesModel = goodsOperationDTO.getSalesModel();
        this.goodsUnit = goodsOperationDTO.getGoodsUnit();
        this.intro = goodsOperationDTO.getIntro();
        this.mobileIntro = goodsOperationDTO.getMobileIntro();
        this.mobileUkIntro = goodsOperationDTO.getMobileUkIntro();
        this.mobileMyIntro = goodsOperationDTO.getMobileMyIntro();
