...
public class TradeBuilder {
    ...
    public TradeDTO buildCart(CartTypeEnum checkedWay) {
        ...
        tradeDTO = buildTradeDTO(tradeDTO);
        return tradeDTO;
    }
    ...
    private TradeDTO buildTradeDTO(TradeDTO tradeDTO){
        String lang = request.getHeader("LANG");
        for (CartVO cartVO : tradeDTO.getCartList()) {
            for (CartSkuVO cartSkuVO : cartVO.getSkuList()) {
                if("zh-Hant".equals(lang)){
                    cartSkuVO.getGoodsSku().setGoodsName(cartSkuVO.getGoodsSku().getGoodsMyName());
                }
                else if("en".equals(lang)){
                    cartSkuVO.getGoodsSku().setGoodsName(cartSkuVO.getGoodsSku().getGoodsUkName());
                }
            }
        }
        return tradeDTO;
