...
public class EsGoodsIndex implements Serializable {
    ...
    public EsGoodsIndex(GoodsSku sku) {
        if (sku != null) {
            ...
            this.goodsMyName = sku.getGoodsMyName();
            this.goodsUkName = sku.getGoodsUkName();
            ...
            this.mobileMyIntro = sku.getMobileMyIntro();
            this.mobileUkIntro = sku.getMobileUkIntro();
            ...
            this.sellingUkPoint = sku.getSellingUkPoint();
            this.sellingMyPoint = sku.getSellingMyPoint();
